...
public:
    ...
    [[nodiscard]] std::vector<BankTransaction> getBankTransactionByUserCardId(int id) const;
...
private:
    ...
    [[nodiscard]] virtual std::vector<BankTransaction> doGetBankTransactionByUserCardId(int id) const = 0;
